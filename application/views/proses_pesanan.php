...
<body>
    <div class="container-fluid">
        <a href="<?php echo base_url('welcome') ?>">
            <div class="btn btn-sm btn-primary "><i class="fas fa-arrow-left"> Kembali</i></div>
        </a>
    </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                <defs>
                    ...
                    <g id="plane">
                        ...
                        <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB">Pesanan Segera diProses</text>
                ...
                <g id="door">
                    ...
                    <g id="sign">
                        ...
                        <text transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF" font-family='Fredoka One' font-size="30">Tunggu</text>
