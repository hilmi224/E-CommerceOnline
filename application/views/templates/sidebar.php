    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('welcome') ?>">
                ...
                <div class="sidebar-brand-text mx-3">G<sub>s</sub>ProMobile</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('kategori/perlengkapan_sekolah') ?>">Perlengkapan Sekolah</a>
                        <a class="collapse-item" href="<?php echo base_url('kategori/obat_obatan') ?>">Obat-Obatan</a>
                        <a class="collapse-item" href="<?php echo base_url('kategori/perlengkapan_rumah') ?>">Perlengkapan Rumah</a>
                    </div>
                </div>

                <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/ice_cream') ?>">
